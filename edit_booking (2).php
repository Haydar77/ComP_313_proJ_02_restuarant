...
$sql = "SELECT t1.booking_id, t1.user_id, t1.booking_date, t1.start_time, t1.end_time, t1.guest_count FROM booking AS t1 WHERE t1.booking_id=". $_REQUEST["booking_id"];
//echo $sql; exit;
